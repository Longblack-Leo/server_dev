...
class Notes(models.Model):
    ...
    is_sponsored = models.IntegerField()
    sponsored_by = models.CharField(max_length=255, blank=True, null=True)
    prepend_type = models.CharField(max_length=255, blank=True, null=True)
    prepend_text = models.CharField(max_length=255, blank=True, null=True)
    prepend_url = models.CharField(max_length=255, blank=True, null=True)
